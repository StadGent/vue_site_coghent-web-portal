...
<div v-if="result" class="w-full overflow-x-hidden">
  <div class="grid sm:grid-cols-2 sm:gap-3 h-auto w-full px-3">
    <div v-if="person" class="pb-0 sm:pb-24">
      ...
      <div class="w-screen">
          <base-meta-data-tab :tab-names="tabs" />
        </div>
      <section>
...
<the-grid :small="true" :no-header="true" class="sm:mt-24"/>
  </div>
</div>
</template>
...
import { GetCreatorByIdDocument, BaseButton, BaseMetaData, BaseMetaDataTab } from 'coghent-vue-3-component-library'
