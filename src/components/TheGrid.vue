    ...
    <div v-if="entityData" class="flex w-full flex-col items-center justify-center">
      ...
      >
        <template #tile="{ entity, tile, small }">
          <router-link :to="{ path: '/entity/' + entity.object_id, query: route.query }" @click="!route.params.entityID ? clearHistory() : undefined" class="absolute top-0 left-0 z-30 h-full w-full">
