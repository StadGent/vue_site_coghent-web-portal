<template>
  <div class="w-full flex flex-cols-2">
      ...
      <div>
        ...
        <ul v-if="assets.length > 0" class="overflow-y-auto">
          <li v-for="asset in assets" :key="asset" class="w-full my-2 align-middle">
            <div class="w-full h-24 bg-background-medium flex flex-cols py-2">
    ...
    <div class="w-1/3">
      ...
      <textarea :placeholder="t('storybox.story.storyPlaceholder')" class="w-full h-2/4 bg-background-light p-4" @change="updateDescription" :value="description"></textarea>
    </div>
  </div>
