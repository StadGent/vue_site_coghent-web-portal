...
type domain = {
  ...
  export const environment: Environment = {
    ...
    collection_api: process.env.COLLECTION_API || "http://localhost:8000",
    search_api: process.env.SEARCH_API || "http://localhost:8002",
    storage_api: process.env.STORAGE_API || "http://localhost:8001",
